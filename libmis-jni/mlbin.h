...
JNIEXPORT jint JNICALL  Java_com_mandroid_libMis_Missile_mlbinFire(JNIEnv* env, jobject obj);
JNIEXPORT jint JNICALL  Java_com_mandroid_libMis_Missile_mlbinMoveDown(JNIEnv* env, jobject obj);
JNIEXPORT jint JNICALL  Java_com_mandroid_libMis_Missile_mlbinMoveUp(JNIEnv* env, jobject obj );
